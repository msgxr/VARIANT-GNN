...
> CV F1 = **0.8779 ± 0.0062** | Test F1 = **0.8963** | MCC = 0.5313 *(precision/recall, binary_f1'i birebir üretir)*
...
| **Eğitim — sızıntısız, gerçek veri** | ✅ Tamamlandı | `models/PROVENANCE.json` → 2026-06-01, group-aware, Test F1=0.8963 |
| **5-fold CV — group-aware** | ✅ Tamamlandı | `reports/cv_report.json` → CV F1=0.8779±0.0062 (StratifiedGroupKFold) |
| **Leakage guard** | ✅ Geçti | 0 Variant_ID train/test'i çaprazlamıyor (`src/cli/modes/train.py`) |
| **Panel bazlı metrikler (test)** | ✅ Tamamlandı | General=0.8842 · KANSER=0.9385 · PAH=0.9173 · CFTR=0.9714 |
...
| **configs/ — binary F1** | ✅ Düzeltildi | `optimize_metric: binary_f1`, GLOBAL cal-türevli eşik θ=0.4456 (canonical; panel-spesifik test'te daha kötü, opt-in) |
