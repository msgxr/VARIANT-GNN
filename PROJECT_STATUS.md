...
> CV F1 = **0.8936 ± 0.0004** | Test F1 = **0.9069** | MCC = 0.5639 *(precision/recall, binary_f1'i birebir üretir)*
...
| **Eğitim — sızıntısız, gerçek veri** | ✅ Tamamlandı | `models/PROVENANCE.json` → 2026-06-01, group-aware, Test F1=0.9069 |
...
| **Panel bazlı metrikler (test)** | ✅ Tamamlandı | General=0.8985 · KANSER=0.9385 · PAH=0.9173 · CFTR=0.9714 |
...
| **configs/ — binary F1** | ✅ Düzeltildi | `optimize_metric: binary_f1`, GLOBAL cal-türevli eşik θ=0.3367 (canonical; panel-spesifik test'te daha kötü, opt-in) |
