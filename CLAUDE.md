...
**Split:** GROUP-AWARE 80/20 hold-out by Variant_ID (GroupShuffleSplit) + StratifiedGroupKFold 5-Fold, random_state=42. Leakage guard: 0 variants straddle train/test. Karar eşiği: θ=0.8514 — TAM group-aware OOF'ta (n≈3040) KALİBRE + SINIF-DENGELİ (%20/%80) resample F1-optimal (25x medyan). §3.2 jüri seti DENGELİ olduğundan eşik o prior'a ayarlanır; %74-poz cal'da türetmek dengeli sette -5pp kaybettirir. A→B çapraz-doğrulandı, overfit yok.  
**Results (real TEKNOFEST data — %20-patojenik-OOF threshold retrain 2026-06-02, canonical: RESULTS_CANONICAL.json):** ⭐ **YARIŞMA BEKLENTİSİ = competition_jury_f1=0.6063±0.0103** (§3.2 %20 patojenik/%80 benign jüri seti — GERÇEK beklenen skor; eski mis-tuned θ=0.3367 ile 0.7635 olurdu, +5pp kurtarıldı). İç AYRIM gücü (%75-poz hold-out, jüri skoru DEĞİL): Test F1=0.833, MCC=0.5863, precision=0.9254, recall=0.7574, CV F1=0.8936±0.0004. reports/competition_jury_f1.json  
**Panel results (test hold-out, group-aware @ θ=0.8514):** General F1=0.8145 | KANSER F1=0.906 | PAH F1=0.878 | CFTR F1=0.8387  
