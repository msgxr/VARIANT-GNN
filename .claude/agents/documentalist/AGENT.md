...
- Metric: always report as "F1=0.8367 (iç hold-out, θ=0.8415); jüri beklentisi dengeli F1=0.6042 (havuzlanmış ±0.0324); RESMİ headline F1=0.631 (4-panel, CFTR dahil; 3-panel tanı CFTR hariç=0.6202)"
