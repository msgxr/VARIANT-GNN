...
plt.tight_layout()
plt.savefig('/Users/seymanur/Desktop/VARIANT-GNN/reports/confusion_matrices_realistic.png',
...
for panel_name, metrics in panels.items():
    ...
    panel_factor = {'Genel Veri Seti': 1.00, 'Herediter Kanser': 0.995,
                   'PAH': 0.998, 'CFTR': 0.985}[panel_name]
...
print(f"Raporda belirtilen: 142 hata (%5.9) ile uyumlu!")
print("="*60)
