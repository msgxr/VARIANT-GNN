...
output_notebook = os.path.join(ROOT, "VARIANT_GNN_Colab_Training.ipynb")
with open(output_notebook, "w", encoding="utf-8") as f:
    json.dump(nb, f, indent=1, ensure_ascii=False)

cells_count = len(nb["cells"])
print(f"✅ Notebook oluşturuldu: {output_notebook}")
print(f"   Hücre sayısı : {cells_count}")
print(f"   Dosya boyutu : {os.path.getsize(output_notebook) / 1024:.1f} KB")
