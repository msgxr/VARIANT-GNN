...
def create_learning_curve():
    ...
    plt.tight_layout()
    plt.savefig("reports/learning_curve_analysis.png", dpi=300, bbox_inches="tight")
    plt.close()
...
def create_ensemble_contribution():
    ...
    plt.tight_layout()
    plt.savefig("reports/ensemble_analysis.png", dpi=300, bbox_inches="tight")
    plt.close()
...
def create_panel_performance():
    ...
    plt.tight_layout()
    plt.savefig("reports/panel_performance.png", dpi=300, bbox_inches="tight")
    plt.close()
...
def create_reliability_metrics():
    ...
    plt.tight_layout()
    plt.savefig("reports/reliability_metrics.png", dpi=300, bbox_inches="tight")
    plt.close()
