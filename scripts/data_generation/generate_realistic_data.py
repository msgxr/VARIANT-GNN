...
TRAIN_FILE = OUTPUT_DIR / "train_variants.csv"
TEST_FILE = OUTPUT_DIR / "test_variants.csv"
...
def main():
    ...
    df_test_blind.to_csv(OUTPUT_DIR / "test_variants_blind.csv", index=False)
    ...
    for panel_name in PANELS:
        ...
        panel_train.to_csv(OUTPUT_DIR / f"train_{panel_name.lower()}.csv", index=False)
        panel_test.to_csv(OUTPUT_DIR / f"test_{panel_name.lower()}.csv", index=False)
