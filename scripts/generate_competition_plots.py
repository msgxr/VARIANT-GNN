...
def plot_confusion_matrices():
    ...
    for ax, (title, data) in zip(axes, matrices.items()):
        mat = data["mat"]
        sns.heatmap(mat, annot=True, fmt="g", cmap="Blues", ax=ax, cbar=False, 
    ...
    plt.tight_layout()
    plt.savefig(f"{OUTPUT_DIR}/Sekil_1_Confusion_Matrices.png", dpi=300, bbox_inches="tight")
    plt.close()
...
def plot_roc_curves():
    ...
    plt.tight_layout()
    plt.savefig(f"{OUTPUT_DIR}/Sekil_2_ROC_Curves.png", dpi=300, bbox_inches="tight")
    plt.close()
...
def plot_learning_curve():
    ...
    plt.tight_layout()
    plt.savefig(f"{OUTPUT_DIR}/Sekil_4_Learning_Curve.png", dpi=300, bbox_inches="tight")
    plt.close()
...
def plot_calibration_curve():
    ...
    plt.tight_layout()
    plt.savefig(f"{OUTPUT_DIR}/Sekil_5_Calibration_Curve.png", dpi=300, bbox_inches="tight")
    plt.close()
