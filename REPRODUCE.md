...
|---|---|---|
| **CV Binary F1** | **0.8779 ± 0.0062** | StratifiedGroupKFold (Variant_ID), 5 fold |
| **Test Binary F1** | **0.8963** | Group-aware 80/20 hold-out |
| Test MCC | 0.5313 | precision/recall, binary_f1'i birebir üretir |
| Panel F1 (test) | General 0.8842 · KANSER 0.9385 · PAH 0.9173 · CFTR 0.9714 | |
...
GLOBAL eşik θ=0.4456 (canonical, models/threshold.json) inference'ta otomatik
...
Cross-validation complete: Binary F1 (§7.3) = 0.8779 ± 0.0062
Leakage guard PASSED: 0 variants straddle train/test
[TEST] [§7.3 PRIMARY] Binary F1 : 0.8963
```
